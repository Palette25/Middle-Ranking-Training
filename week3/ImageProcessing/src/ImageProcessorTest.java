...
public class ImageProcessorerTest{
	...
	public void test1() throws IOException{
		...
		FileInputStream firstImg = new FileInputStream("img/1.bmp");
		
		BufferedImage buff1 = ImageIO.read(firstImg);
		//Invoke myRead
		BufferedImage buff2 = ImageToBufferedImage(imageioer.myRead("img/1.bmp"));
	...
	public void test2() throws IOException{
		ImplementImageIO imageioer = new ImplementImageIO();
		Image secondImg = imageioer.myRead("img/1.bmp");
		imageioer.myWrite(secondImg, "img/0.bmp");

		FileInputStream target = new FileInputStream("img/0.bmp");
	...
	public void test3() throws IOException{
		...
		//Invoke myRead
		BufferedImage resultBlue = ImageToBufferedImage(processor.showChanelB(ImageIO.read(new File("img/1.bmp"))));
		BufferedImage resultGray = ImageToBufferedImage(processor.showGray(ImageIO.read(new File("img/1.bmp"))));
		BufferedImage resultGreen = ImageToBufferedImage(processor.showChanelG(ImageIO.read(new File("img/1.bmp"))));
		BufferedImage resultRed = ImageToBufferedImage(processor.showChanelR(ImageIO.read(new File("img/1.bmp"))));
